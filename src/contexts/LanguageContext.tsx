...
const translations = {
  en: {
    ...
    // Hero
    'hero.title1': 'Your UAE Advisor for',
...
'contact.submit': 'Send Message',
  ...
  ar: {
    ...
    // Hero
    'hero.title1': "مستشاركم في الإمارات ل" ,
    'hero.title2': "الأعمال، التأشيرات والمزيد",
    'hero.description': "تأسيس الأعمال، التأشيرات، الموارد البشرية والمزيد — نقدم لكم المشورة في كل ذلك.",
